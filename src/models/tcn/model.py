...
class TCN(BaseModel):
    ...
    def __init__(
            ...
            if i == 0:
                ...
                self.blocks.append(
                    ConditionalBlock(
                        ...
                        conditional_in_channels=conditional_size,
        ...
        self.output_conv = nn.Conv1d(
            in_channels=num_channels, out_channels=1, kernel_size=1
        )
    ...
    def _extract_input_from_batch(
        ...
        repeated_cat = embedded_cat.repeat_interleave(
            self.context_length + self.prediction_length, dim=1
        ).float()
...
class ConditionalBlock(nn.Module):
    ...
    def __init__(
        ...
        self.conditional_block = ResidualBlock(
            d, conditional_in_channels, out_channels, k
        )
